...
namespace Application.Commands.Create
{
    ...
    {
        public record RegisterProviderCommand : IRequest<BaseResponse<RegisterResponseModel>>
        {
        ...
        public class Handler(IUserRepository userRepository, IEmailConfirmationToken emailToken, IUnitOfWork unitOfWork) : IRequestHandler<RegisterProviderCommand, BaseResponse<RegisterResponseModel>>
        {
            public async Task<BaseResponse<RegisterResponseModel>> Handle(RegisterProviderCommand request, CancellationToken cancellationToken)
            {
